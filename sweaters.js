...
window.onload = function() {
    if(window.location == "https://nick-donfris-jacket-website.herokuapp.com/sweaters/login.html"){
        document.getElementById("login").onclick = login;
    }
    if(window.location == "https://nick-donfris-jacket-website.herokuapp.com/sweaters/newmember.html"){
        document.getElementById("create_account").onclick = createaccount;
    }
    if (window.location == "https://nick-donfris-jacket-website.herokuapp.com/sweaters/shop.html"){
        loadAll();
...
function login(){
    ...
    .then((responseText) => {
        ...
        if (obj.length == 0) {
            ...
            location.replace("https://nick-donfris-jacket-website.herokuapp.com/sweaters/shop.html");
        }
    })
    .catch((error) => {
        console.log(error);
...
function createaccount(){
    ...
    .then((response) => response.text())
    .then((responseText) => {
        location.replace("https://nick-donfris-jacket-website.herokuapp.com/sweaters/login.html");
    })
    .catch((error) => {
        console.log(error);
        loginerror.innerHTML = "<p> Opps, Username or Password Incorrect </p>";
